		...
		<>
			...
			<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
				<aside className="items-center grid-flow-col">
					...
					<p>
						Chioma Onwenonye foundation <br />
				...
				<nav className="md:place-self-center md:justify-self-end">
					<div className="grid grid-flow-col gap-4">
						<a
							href="https://www.tiktok.com/@ch.onwenonyefoundation?_t=8fnEGYHEibR&_r=1"
							target="_blank"
						>
							<FaTiktok className="w-6 h-6 fill-current" />
						</a>
						<a
							href="https://instagram.com/chiomaonwenonyefoundation?igshid=MzMyNGUyNmU2YQ=="
							target="_blank"
						>
